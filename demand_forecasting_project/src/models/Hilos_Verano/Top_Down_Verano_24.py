...
forecast_path = 'data/processed/Verano/2024_forecast_Verano_ETS.csv'  # Ruta del archivo generado
...
# Guardar resultados
family_forecast_df.to_csv('data/processed/Verano/forecast_family_2024.csv', index=False)
product_forecast_df.to_csv('data/processed/Verano/forecast_product_2024.csv', index=False)
