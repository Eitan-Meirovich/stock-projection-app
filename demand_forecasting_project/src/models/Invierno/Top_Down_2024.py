...
forecast_path = 'data/processed/Invierno/2024_forecast_Invierno2.csv'  # Ruta del archivo generado
...
# Guardar resultados
family_forecast_df.to_csv('data/processed/Invierno/forecast_family_2024.csv', index=False)
product_forecast_df.to_csv('data/processed/Invierno/forecast_product_2024.csv', index=False)
