...
# Cargar datos de la Super Familia "Invierno"
file_path = 'data/processed/processed_data_invierno.csv'  # Ajusta la ruta según tu sistema
...
plt.title('Ventas Mensuales - Super Familia "Invierno"')
plt.xlabel('Fecha')
...
plt.title('Pronóstico Optimizado SARIMA - Super Familia "Invierno"')
plt.xlabel('Fecha')
plt.ylabel('Ventas Totales')
plt.legend()
plt.grid()
...
forecast_df.to_csv('data/processed/Invierno/sarima_forecast_invierno.csv', index=False)
