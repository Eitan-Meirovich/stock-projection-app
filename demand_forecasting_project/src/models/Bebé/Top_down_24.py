...
forecast_path = 'data/processed/Bebé/2024_forecast_Bebe.csv'  # Ruta del archivo generado
...
# Guardar resultados
family_forecast_df.to_csv('data/processed/Bebé/forecast_family_2024.csv', index=False)
product_forecast_df.to_csv('data/processed/Bebé/forecast_product_2024.csv', index=False)
